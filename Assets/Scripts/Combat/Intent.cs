...
public struct Intent
{
    ...
    public int hitCount; //How many times the enemy will attack this turn. Based on maxHits in EnemyData
    ...
    public Intent(IntentType type, int value, int hitCount, Character target, Sprite icon)
    {
        this.type = type;
        this.value = value;
